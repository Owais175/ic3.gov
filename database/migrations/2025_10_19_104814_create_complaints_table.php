...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('complaints', function (Blueprint $table) {
            $table->id();
            $table->boolean('is_victim')->nullable();
            ...
            $table->string('victim_age_range', 20)->nullable();
            ...
            $table->string('victim_country', 3);
            $table->string('victim_state', 2)->nullable();
            ...
            $table->boolean('money_sent')->nullable();
        ...
        Schema::create('subjects', function (Blueprint $table) {
            ...
            $table->string('mail_stop', 50)->nullable();
