        ...
        <ul class="display-flex flex-justify usa-list--unstyled grid-row grid-gap">
            <li class="text-center tablet:grid-col-4">
                <div class="post-hygiene">
                    <img src="image/hygiene-post-1.jpg" class="img-fluid" alt="">
                </div>
            </li>
            <li class="text-center tablet:grid-col-4">
                <div class="post-hygiene">
                    <img src="image/hygiene-post-2.jpg" class="img-fluid" alt="">
                </div>
            </li>
            <li class="text-center tablet:grid-col-4">
                <div class="post-hygiene">
                    <img src="image/hygiene-post-3.jpg" class="img-fluid" alt="">
                </div>
            </li>
            <li class="text-center tablet:grid-col-4">
                <div class="post-hygiene">
                    <img src="image/hygiene-post-4.jpg" class="img-fluid" alt="">
                </div>
            </li>
            <li class="text-center tablet:grid-col-4">
                <div class="post-hygiene">
                    <img src="image/hygiene-post-5.jpg" class="img-fluid" alt="">
                </div>
            </li>
            <li class="text-center tablet:grid-col-4">
                <div class="post-hygiene">
                    <img src="image/hygiene-post-6.jpg" class="img-fluid" alt="">
                </div>
            </li>
        </ul>
    </section>
